...
# 1. core/security.py
with open(os.path.join(base_dir, 'core', 'security.py'), 'w', encoding='utf-8') as f:
    f.write("""import os
import bcrypt
...
# 2. core/email.py
with open(os.path.join(base_dir, 'core', 'email.py'), 'w', encoding='utf-8') as f:
    f.write("""import os
import requests
...
# 3. core/seeder.py
with open(os.path.join(base_dir, 'core', 'seeder.py'), 'w', encoding='utf-8') as f:
    f.write("""from app.db import models, database
...
# 4. routers/auth.py
with open(os.path.join(base_dir, 'routers', 'auth.py'), 'w', encoding='utf-8') as f:
...
# 5. routers/pricing.py
with open(os.path.join(base_dir, 'routers', 'pricing.py'), 'w', encoding='utf-8') as f:
    f.write("""from fastapi import APIRouter, Depends, HTTPException
from sqlalchemy.orm import Session
...
# 6. routers/contacts.py
with open(os.path.join(base_dir, 'routers', 'contacts.py'), 'w', encoding='utf-8') as f:
    f.write("""import os
...
# 7. routers/enrollments.py
with open(os.path.join(base_dir, 'routers', 'enrollments.py'), 'w', encoding='utf-8') as f:
...
# 8. routers/courses.py
with open(os.path.join(base_dir, 'routers', 'courses.py'), 'w', encoding='utf-8') as f:
    f.write("""from fastapi import APIRouter, Depends, HTTPException
from sqlalchemy.orm import Session
from typing import List
from app.db import models, database
...
# 9. routers/game.py
with open(os.path.join(base_dir, 'routers', 'game.py'), 'w', encoding='utf-8') as f:
    f.write("""from fastapi import APIRouter, Depends, HTTPException
from sqlalchemy.orm import Session
...
print("Successfully created core and router files.")
