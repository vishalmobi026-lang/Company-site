    ...
    <div className="fixed inset-0 bg-white flex flex-col items-center justify-center z-[9999]">
      <div className="w-64 h-64 sm:w-80 sm:h-80 relative">
         ...
         <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <img src="/logo.webp" alt="Azhagiyamandapam" className="w-20 h-20 object-contain drop-shadow-md animate-pulse" />
         </div>
      </div>
      <p className="mt-4 font-primary font-semibold text-slate-500 tracking-wide animate-pulse">Loading G-Tec Azhagiyamandapam...</p>
    </div>
  );
}
