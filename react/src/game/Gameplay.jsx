...
export default function NeonStrikeGame({ onClose }) {
  ...
  useEffect(() => {
    fetch("https://company-site-jxbr.onrender.com/api/countries")
      .then((res) => res.json())
      .then((data) => {
    ...
    fetch("https://company-site-jxbr.onrender.com/categories")
      .then((res) => res.json())
      .then((data) => {
        if (Array.isArray(data)) {
          setCategories(data);
  ...
  const submitForm = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://company-site-jxbr.onrender.com/questions?topic=${encodeURIComponent(formData.course)}`
      )
      ...
      if (!Array.isArray(finalQuestions) || finalQuestions.length === 0) {
        ...
        await fetch(
          `https://company-site-jxbr.onrender.com/generate-ai-questions?topic=${encodeURIComponent(formData.course)}`
        )
  ...
  const endGame = async () => {
    ...
    try {
      await fetch("https://company-site-jxbr.onrender.com/gamescores/add", {
        method: "POST",
